/****************************************************************************
** Meta object code from reading C++ file 'TicketSystem.h'
**
...
#error "The header file 'TicketSystem.h' doesn't include <QObject>."
...
void TicketSystem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->userLoggedIn((*reinterpret_cast< std::add_pointer_t<User*>>(_a[1]))); break;
        case 1: _t->userLoggedOut(); break;
        case 2: _t->ordersUpdated(); break;
        case 3: _t->trainsUpdated(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (TicketSystem::*)(User * )>(_a, &TicketSystem::userLoggedIn, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (TicketSystem::*)()>(_a, &TicketSystem::userLoggedOut, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (TicketSystem::*)()>(_a, &TicketSystem::ordersUpdated, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (TicketSystem::*)()>(_a, &TicketSystem::trainsUpdated, 3))
            return;
    }
}
...
// SIGNAL 0
void TicketSystem::userLoggedIn(User * _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void TicketSystem::userLoggedOut()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void TicketSystem::ordersUpdated()
{
    QMetaObject::activate(this, &staticMetaObject, 2, nullptr);
}

// SIGNAL 3
void TicketSystem::trainsUpdated()
{
