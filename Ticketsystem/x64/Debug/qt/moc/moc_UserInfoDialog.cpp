...
namespace {
struct qt_meta_tag_ZN14UserInfoDialogE_t {};
} // unnamed namespace

template <> constexpr inline auto UserInfoDialog::qt_create_metaobjectdata<qt_meta_tag_ZN14UserInfoDialogE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<UserInfoDialog, qt_meta_tag_ZN14UserInfoDialogE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject UserInfoDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14UserInfoDialogE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14UserInfoDialogE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN14UserInfoDialogE_t>.metaTypes,
    nullptr
} };
...
void *UserInfoDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14UserInfoDialogE_t>.strings))
